...
main = do
   runTestTT $ 
      TestList [ 
        TestList [ -- prva fcia
          TestCase $ assertEqual ("horizont " ++ (show o1)) (horizont o1) ( F.horizont o1 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h1)) (horizont h1) ( F.horizont h1 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h2)) (horizont h2) ( F.horizont h2 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h3)) (horizont h3) ( F.horizont h3 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h4)) (horizont h4) ( F.horizont h4 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h5)) (horizont h5) ( F.horizont h5 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h6)) (horizont h6) ( F.horizont h6 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h7)) (horizont h7) ( F.horizont h7 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h8)) (horizont h8) ( F.horizont h8 )
          ,
          TestCase $ assertEqual ("horizont " ++ (show h9)) (horizont h9) ( F.horizont h9 )
          ,
